...
func main() {
	...
	server.RegisterMetric(types.MissedMessageMetric, &metrics.MissedMessage{})
	server.RegisterMetric(types.MissedRelevantMessageMetric, &metrics.MissedRelevantMessage{})
